...
const FeesPendingStudentsIndex = () => {
  ...
  useEffect(() => {
    Axios.get(`${config.apiURL}/students/getAllpendingStudents`)
      .then((res) => {
  ...
  useEffect(() => {
    Axios.get(`${config.apiURL}/students/getAllpendingStudents`)
      .then((res) => {
        console.log(res.data);  // Check if vanRemaningFees exists in the response data
        setStuData(res.data);
        setTotalPages(Math.ceil(res.data.length / dataPerPage));
      })
      .catch((err) => {
  ...
  useEffect(() => {
    Axios.get(`${config.apiURL}/dashboard/classes`)
      .then((res) => {
        setClsData(res.data);
      })
      .catch((err) => {
        console.log("Error fetching classes data", err);
      });
  }, []);
