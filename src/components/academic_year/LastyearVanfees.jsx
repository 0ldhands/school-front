...
function LastyearVanfees() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            for (const data of payfee) {
                ...
                const response = await axios.post(`${config.apiURL}/academicyear/lastyearvanfeeslogdata`, formDataToSend);
    ...
    return (
        <div className="fee-collection">
            <h2>LastYear Van Fee Collection</h2>
            ...
            {payfee.map((data) => (
                <form onSubmit={handleSubmit} key={data.stu_id}>
                                ...
                                <td>
                                    <div style={{ position: 'relative', display: 'inline-block' }} >
                                        <input
                                            ...
                                            style={{ color: data.van <= 0 ? 'green' : 'red ' }}
                                            readOnly
                                        />
                                        {data.van <= 0 ? (<CheckCircleOutlineSharpIcon
                                            style={{
                                                position: 'absolute',
                    ...
                    <button type="submit" style={{ display: calculateRemainingFees(data.van, data.vanpayFees) >= 0 ? 'inline-block' : 'none' }}>
  Submit
</button>
...
export default LastyearVanfees;
